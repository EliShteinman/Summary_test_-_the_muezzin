...
# ---------------------------------------------------------
# analyzer
ANALYZER_HOSTILE_WORDS = os.getenv(
    "ANALYZER_HOSTILE_WORDS",
...
ANALYZER_LESS_HOSTILE_WORDS = os.getenv(
    "ANALYZER_LESS_HOSTILE_WORDS",
    "RnJlZWRvbSBGbG90aWxsYSxSZXNpc3RhbmNlLExpYmVyYXRpb24sRnJlZSBQYWxlc3RpbmUsR2F6YSxDZWFzZWZpcmUsUHJvdGVzdCxVTlJXQQ==",
)
ANALYZER_DANGEROUS_LIST_SCORE = int(os.getenv("ANALYZER_DANGEROUS_LIST_SCORE", 10))
ANALYZER_LOW_DANGEROUS_LIST_SCORE = int(os.getenv("ANALYZER_LOW_RISK_SCORE", 5))
ANALYZER_SCORING_TO_DETERMINE_RISK = int(
    os.getenv("ANALYZER_SCORING_TO_DETERMINE_RISK", 15)
)
ANALYZER_MEDIUM_RISK_SCORE = int(os.getenv("ANALYZER_MEDIUM_RISK_SCORE", 20))
ANALYZER_HIGH_RISK_SCORE = int(os.getenv("ANALYZER_HIGH_RISK_SCORE", 30))
ANALYZER_NO_RISK_SCORE = ANALYZER_SCORING_TO_DETERMINE_RISK

ANALYZER_ELASTICSEARCH_PROTOCOL = os.getenv("INDEXER_ELASTICSEARCH_PROTOCOL", "http")
ANALYZER_ELASTICSEARCH_HOST = os.getenv("INDEXER_ELASTICSEARCH_HOST", "localhost")
ANALYZER_ELASTICSEARCH_PORT = int(os.getenv("INDEXER_ELASTICSEARCH_PORT", 9200))
ANALYZER_ELASTICSEARCH_INDEX_DATA = os.getenv(
    "INDEXER_ELASTICSEARCH_INDEX_DATA", "podcasts"
)
