...
INDEXER_ELASTICSEARCH_INDEX_DATA = os.getenv("INDEXER_ELASTICSEARCH_INDEX_DATA", "podcasts")
INDEXER_ELASTICSEARCH_INDEX_LOG = os.getenv("INDEXER_ELASTICSEARCH_INDEX_LOG", "podcasts_log")